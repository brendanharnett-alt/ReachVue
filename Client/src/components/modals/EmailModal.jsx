...
// This uses editorProps for paste handling and a simple plugin for typing
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (value === "custom") {
                      ...
                      const customInput = document.getElementById('custom-font-size-email')
                      customInput?.focus()
                    } else if (value) {
                      editor
                        .chain()
