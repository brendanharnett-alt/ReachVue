  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <div className="px-[2.5vw]">
        <DialogContent
          className={`transition-all duration-500 ease-in-out flex items-start ${
            showThread ? "w-[95vw] max-w-none" : "max-w-3xl mx-auto"
          }`}
        >
          {/* LEFT: COMPOSE (fixed width) */}
          <div
            className={`transition-all duration-500 ${
              showThread ? "w-[768px]" : "w-full"
            }`}
          >
          ...
          {/* RIGHT: THREAD PANEL */}
          {showThread && (
            <div className="flex-grow max-w-[calc(95vw-768px)] border-l border-gray-300/70 pl-4 overflow-y-auto">
              <h3 className="text-sm font-semibold mb-2">Thread</h3>
              <div className="space-y-3 text-sm text-gray-700">
                <p>
                  <strong>Brendan Harnett:</strong> Initial message about meeting schedule.
                </p>
                <p>
                  <strong>John Doe:</strong> Thanks Brendan — can we push to next week?
                </p>
                <p>
                  <strong>Brendan Harnett:</strong> Sure, no problem. Will send a new invite.
                </p>
              </div>
            </div>
          )}
