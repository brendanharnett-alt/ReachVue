...
export default function ContactsTable() {
  ...
  // 🔹 Helper: Apply Tag Filter Logic (Salesloft-style)
  function applyTagFilter(contact, selectedTags, mode) {
    ...
    switch (mode) {
      ...
      case "isNot":
        // Exclude contacts that have ANY of the selected tags
        return selectedTags.length === 0 || !tags.some((t) => selectedTags.includes(t))
      case "empty":
  ...
  return (
    <div className="rounded-xl border bg-white p-4 shadow-sm">
      ...
      {/* Shared Filter Modal (for all EXCEPT Tag) */}
      {openFilterKey && openFilterKey !== "tag" && (
        <FilterModal
          open={!!openFilterKey}
