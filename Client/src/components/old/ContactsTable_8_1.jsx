...
const handleRefreshEmailWindow = () => {
  window.postMessage({
    ...
    payload: {
      type: "reachvue:refresh-outlook-tab",
    },
  }, "*");
};
    ...
    <div className="rounded-xl border bg-white p-4 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-2">
        ...
        <div className="flex flex-wrap gap-2">
           <Button className="bg-blue-600 text-white hover:bg-blue-700" onClick={handleRefreshEmailWindow}>Refresh Email Window</Button>
      ...
      {/* Table */}
      <div className="relative h-[66vh] overflow-auto pb-5">
        <div className="min-w-[1200px] w-fit">
          <table className="table-fixed text-xs w-full">
            <thead className="bg-muted">
              <tr className="text-left text-xs">
                <th className="p-3 w-[40px] font-medium sticky top-0 bg-muted z-10"> <input type="checkbox" /> </th>
                <th className="p-3 w-[160px] font-medium sticky left-0 top-0 bg-muted z-30">Name</th>
                <th className="p-3 w-[200px] font-medium sticky left-[160px] top-0 bg-muted z-30 border-r border-gray-300">Title</th>
                <th className="p-3 w-[160px] font-medium sticky top-0 bg-muted z-10">Company</th>
                <th className="p-3 w-[160px] font-medium sticky top-0 bg-muted z-10">Phone</th>
                <th className="p-3 w-[160px] font-medium sticky top-0 bg-muted z-10">Last Touch</th>
                <th className="p-3 w-[160px] font-medium sticky top-0 bg-muted z-10">Tags</th>
                <th className="p-3 w-[240px] font-medium sticky top-0 bg-muted z-10">Email</th>
                <th className="p-3 w-[120px] font-medium sticky top-0 bg-muted z-10">Actions</th>
              </tr>
            </thead>
            <tbody>
              {filteredContacts.map((contact) => (
                <tr key={contact.id} className="border-t">
                  ...
                  <td className="p-3 font-semibold text-blue-600 truncate sticky left-0 bg-white z-10">{contact.first_name} {contact.last_name}</td>
                  <td className="p-3 truncate sticky left-[160px] bg-white z-10 border-r border-gray-300">{contact.title}</td>
