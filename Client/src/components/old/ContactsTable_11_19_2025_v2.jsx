...
export default function ContactsTable() {
  ...
  // Unique values, filters, grouping... (UNCHANGED)
  // ----------------------------------------------------
  // (I am keeping this exactly the same — no edits)
  // ----------------------------------------------------
  ...
  return (
    <div className="rounded-xl border bg-white p-4 shadow-sm">
      ...
      <EmailModal
        ...
        replyThreadId={emailPreset?.replyThreadId || null}
        parentTouchId={emailPreset?.parentTouchId || null}
      />
      ...
      <TouchHistoryModal
        ...
        onReply={({ initialSubject, replyThreadId, parentTouchId }) =>
